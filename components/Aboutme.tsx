            ...
            <div className="flex flex-row justify-center items-start overflow-hidden h-screen">
                <div className="w-9/12 mx-auto text-left lg:p-20">
                    ...
                    <h2 className="mt-10 font-bold text-gray-500">
                        Hello! I reside in ap-southeast-1 with background in Mechanical Engineering and Computer Science (AI).
                    ...
                    <h2 className="mt-5 font-bold text-gray-500">
                        As a cloud enthusiast I primarily use <img alt="aws" src="https://img.shields.io/badge/AWS-%23FF9900.svg?style=for-the-badge&logo=amazon-aws&logoColor=white" />
